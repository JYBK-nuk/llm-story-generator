...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/h3@1.13.0/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/vue-bundle-renderer@2.1.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/devalue@5.1.1/node_modules/devalue/index.js';
import destr from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/destr@2.0.3/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/ufo@1.5.4/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/vue@3.5.13_typescript@5.7.2/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/@unhead+ssr@1.11.14/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/unhead@1.11.14/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/unenv@1.10.0/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/consola@3.3.3/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/vue@3.5.13_typescript@5.7.2/node_modules/vue/index.mjs';
import { hash } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/ohash@1.1.4/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/unstorage@1.14.4_db0@0.2.1_ioredis@5.4.2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/unstorage@1.14.4_db0@0.2.1_ioredis@5.4.2/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://H:/Repos/llm-story-generator/node_modules/.pnpm/@unhead+shared@1.11.14/node_modules/@unhead/shared/dist/index.mjs';
...
const _Xu2m8RG2SK = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "H:/Repos/llm-story-generator";
...
const _lazy_dmlqgx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dmlqgx, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dmlqgx, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"H:/Repos/llm-story-generator/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"H:\\Repos\\llm-story-generator","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"H:\\Repos\\llm-story-generator\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"H:\\Repos\\llm-story-generator\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"H:\\Repos\\llm-story-generator\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"H:\\Repos\\llm-story-generator\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file://H:/Repos/llm-story-generator/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://H:/Repos/llm-story-generator/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
