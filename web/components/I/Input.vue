...
<template>
  ...
  >
    <input
      ...
      :class="
        cn(
          `flex h-10 w-full border-none bg-gray-100 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm  file:border-0 file:bg-transparent 
...
<style scoped>
input {
  box-shadow: 0px 2px 3px -1px rgba(0, 0, 0, 0.01),
    0px 1px 2px 2px rgba(25, 28, 33, 0.02),
    0px 0px 0px 1px rgba(25, 28, 33, 0.01);
}
* {
  --blue-500: #3b82f6;
}
